...
local function CDOCBBI_fake_script() -- Freecam.FreecamScript 
	...
	local Input = {} do
		...
		function Input.Vel(dt)
			...
			local shift = UserInputService:IsKeyDown(Enum.KeyCode.LeftControl)
...
coroutine.wrap(CDOCBBI_fake_script)()
