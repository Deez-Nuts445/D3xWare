...
credits:Button("Join the discord!",function()
local Module = loadstring(game:HttpGet("https://raw.githubusercontent.com/RegularVynixu/Utilities/main/Discord%20Inviter/Source.lua"))()
Module.Prompt({ invite = "6kp4eSMq8k", name = "O2 Scripts" }) -- name is optional
Module.Join("6kp4eSMq8k")
end)
credits:Button("Run Old D3xWare"function()
	loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Deez-Nuts445/D3xWare/main/old.lua"))()
end)
